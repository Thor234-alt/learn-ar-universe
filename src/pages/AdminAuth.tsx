...
import { QrCode, Shield, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Manage your AR learning platform</p>
        </div>
        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2 text-white">
              ...
              <span>{isLogin ? 'Admin Sign In' : 'Create Admin Account'}</span>
            </CardTitle>
            <CardDescription className="text-gray-400">
              {isLogin ? 'Access your administrative dashboard.' : 'Set up a new administrative account.'}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="text-center pt-4 border-t border-slate-600">
              <p className="text-sm text-gray-400 mb-2">Are you a student?</p>
              <Link to="/student-auth" className="text-orange-400 hover:text-orange-300 text-sm font-medium">
